...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        /* Adaptive Layout based on Header/Sidebar */
        .layout-with-sidebar { display: flex; }
        .layout-with-header { padding-top: 7rem !important; }
...
<body class="{{ in_array(auth()->user()->role_id, [3, 4]) ? 'layout-with-header' : 'layout-with-sidebar' }}">
