...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Área de contenido — aquí vive @yield('content') */
        .pf-content {
            flex: 1;
            padding: 20px 24px;
            overflow-y: auto;
...
<nav class="pf-nav">
    ...
    <a href="{{ route('gerente.configuracion') }}"
       class="pf-nav-item {{ request()->routeIs('gerente.configuracion') ? 'active' : '' }}">
        <div class="pf-nav-dot"></div>
        Configuración
    </a>

    <a href="{{ route('gerente.fechas_corte') }}"
       class="pf-nav-item {{ request()->routeIs('gerente.fechas_corte') ? 'active' : '' }}">
        <div class="pf-nav-dot"></div>
        Fechas de corte
    </a>

    <a href="{{ route('gerente.indicadores') }}"
       class="pf-nav-item {{ request()->routeIs('gerente.indicadores') ? 'active' : '' }}">
        <div class="pf-nav-dot"></div>
        Indicadores
    </a>
        ...
        <div class="pf-user">
            ...
            <div>
                ...
                <div class="pf-user-role">{{ Auth::user()->role->nombre ?? 'Sin rol' }}</div>
            </div>
        </div>
