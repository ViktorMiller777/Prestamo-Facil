...
<head>
    ...
    <title>Coordinador - Distribuidoras</title>
        ...
        <main class="contenido">
            <div class="header-section">
                ...
                <p class="welcome-text">
                    ...
                    Consulta la información de las distribuidoras activas.
                </p>
            </div>
            ...
            <div class="panel">
                <div class="box-header">
                    <div>
                        <h2>Distribuidoras Registradas</h2>
                        <p style="font-size: 0.8rem; color: #64748b; font-weight: 400;">Vista de consulta para coordinación.</p>
                    </div>
