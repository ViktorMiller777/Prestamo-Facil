...
<body>
  ...
  <aside class="pf-sidebar">
    ...
    <a href="{{ route('verificador.bandeja') }}" class="pf-nav-item">
        <div class="pf-nav-dot"></div>Bandeja de presolicitudes
    </a>
    <a href="{{ route('verificador.expediente') }}" class="pf-nav-item">
        <div class="pf-nav-dot"></div>Expediente digital
    </a>
    <a href="{{ route('verificador.domicilio') }}" class="pf-nav-item">
